      ...
      <div className='heading-container flex flex-row w-2xl px-2 py-1 justify-between'>
        <img className='logo-img' src='\icons\logo.png' alt='Logo Image' width="100px" height="50px" />
            <h1 className='title-txt hidden lg:flex  lg:text-4xl font-serif bg-gradient-to-r from-blue-950 to-indigo-600 bg-clip-text text-transparent py-2 px-1 my-2 mx-3 font-black'>STAMPORA DASHBOARD</h1>
                ...
                <div className='link-container hidden md:flex flex-column w-md ps-4 pe-1 py-1 gap-2 text-xl font-bold font-serif text-blue-900'>
                        <Link className='px-2 py-2 my-2' to="/home">Home</Link>
                        <Link className='px-2 py-2 my-2' to="/products">Products</Link>
                        <Link className='px-2 py-2 my-2'to="/customers">Users</Link>
                        <Link className='px-2 py-2 my-2'to="/orders">Orders</Link>
                </div>
                 ...
                 </nav>
                {
                    ...
                    <div className='menu md:hidden flex flex-col mt-0 p-1 w-screen border text-blue-900 font-bold'>
                       ...
                       <button  className= ' m-0.5 p-1 block link-btn bg-white' onClick={()=>setIsOpen(!isOpen)}> <Link className=' ' to="/customers ">Users</Link></button> 
                       <button  className= ' m-0.5 p-1 block link-btn bg-white'  onClick={()=>setIsOpen(!isOpen)}> <Link className='px-2 py-2 my-2 bg-white hover:bg-gradient-to-r hover:from-cyan-200 hover:to-teal-300 hover:to-yellow-300 focus:outline-offset-2 focus:outline-blue-900' to="/orders">Orders</Link></button> 
                </div>
